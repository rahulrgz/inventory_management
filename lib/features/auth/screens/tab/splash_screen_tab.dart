...
class SplashScreenTab extends ConsumerStatefulWidget {
  const SplashScreenTab({Key? key}) : super(key: key);

  @override
  ConsumerState<SplashScreenTab> createState() => _RootPageState();
}

class _RootPageState extends ConsumerState<SplashScreenTab> {
