...
class PurchaseReturnPartyMobile extends ConsumerWidget {
  final String encode;
  const PurchaseReturnPartyMobile({super.key, required this.encode});
