...
class PurchasePartyScreenMobile extends StatelessWidget {
  final String encode;
  const PurchasePartyScreenMobile({super.key, required this.encode});
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: Center(
                              child: Text('₹ ${purchase.totalPrice}',
                                  style: TextStyle(
