...
class SaleStockScreenTab extends ConsumerStatefulWidget {
  final String sid;
  final String uid;
  const SaleStockScreenTab({Key? key, required this.uid, required this.sid})
      : super(key: key);

  @override
  ConsumerState<SaleStockScreenTab> createState() => _SaleStockScreenState();
}

class _SaleStockScreenState extends ConsumerState<SaleStockScreenTab> {
                  ...
                  children: [
                    ...
                    Padding(
                      padding: EdgeInsets.only(
                          left: deviceWidth * 0.03, right: deviceWidth * 0.04),
                      child: SizedBox(
